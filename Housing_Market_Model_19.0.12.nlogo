...
@#$#@#$#@
<experiments>
  <experiment name="240815_baseline" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="240815_RTB_offToOn" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [set Right-to-buy? mRTB]</go>
  ...
  <experiment name="240815_interest_3to8" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [
set InterestRate mInterest
...
set InterestRateRTB mInterestRTB
  ...
  <experiment name="240815_LTV_90to60" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [
set MaxLoanToValue mLTV

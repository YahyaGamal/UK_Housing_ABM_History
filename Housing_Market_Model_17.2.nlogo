...
to owners-leave [n-owners]
  ...
  let n-leave-rent min (list count owners-rent (ExitRate * n-owners / 200))
  ask n-of n-leave-rent owners-rent [
   ...
   if any? records [  ;; if there are records left
    ...
    ask houses-to-demolish [
      ...
      if myType = "mortgage" and for-sale? = false [
        ;; add the sale-price to the capital (this is applied as per the previous model)
        ask my-owner [
...
to update-owners
  ...
  ;; myType condition was condered againist the value 0, Modified to "rent" to align with the new model.
...
"" ""
PENS
"default" 1.0 0 -13791810 true "" "plot median [rent-price] of houses with [myType = \"rent\"]"
...
8. added on-market-type
	a. represents the market which the 'owners' is using to buy/rent (can be "buy-to-let", "mortgage", "rent")	

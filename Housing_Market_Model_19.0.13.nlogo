...
to reset
  ...
  set rich-reference "XY modify radius houses"
  set Savings 20
  set SavingsRent 5
...
to build-owners
  ...
  ask available-social [
    ...
    hatch-owners 1 [  ;; create an owner (tenant) inside this house
      ...
      ;; assure households can afford the rent, if now, decrease the rent
      let rent (income-temp * Affordability / (ticksPerYear * 100 )) * (social-to-private-rent / 100)
      if rent > (income * Affordability / (ticksPerYear * 100 )) [set rent (income * Affordability / (ticksPerYear * 100 ))]
       ;; create rent while assuring the household can afford it
...
;        ifelse TargetOwnedRentPercent < (count houses with [myType = "mortgage"] / count houses) * 100  and ticks > 50[
;          let t random 2
;          ifelse t = 0
;          [set myType "mortgage" set force-external-landlord true]
;          [set myType "rent"]
;        ]
;        [
;          let t random 2
...
;        ]
      ...
      [
        ...
        set propensity-social random-float 1.0
        set propensity-wait-for-RTB random-float 1.0
        if propensity-social > propensity-social-threshold [
          set myType "social"
        ]
        ...
        ;; Enter the market based on myType (i.e., "mortgage" or "rent" or "social")
        enter-market self myType
        ;; assign the age of the entering agent
        assign-age self
        hide-turtle  ;; new comers have no houses, so they are nowhere to be seen
...
to manage-discouraged
  ...
  if maxHomelessPeriod  > 0 [ ; meaning if this value is set
    ...
    ask owners with [ my-house = "external" and on-market-type = "buy-to-let" ] [
      ...
      if length my-ownership-temp = 1 and homeless > maxHomelessPeriod [
        set homeless 0
        set on-market-type nobody
      ]
    ]
  ]
  ask owners with [ my-house = "external" and on-market-type = nobody ] [
    let my-ownership-temp remove-duplicates my-ownership
...
to manage-market-participation [input-owners]
  ...
  let not-well-off-social input-owners with [on-market? = false and is-house? my-house and myType = "social" and (my-rent * TicksPerYear) > (eviction-threshold-social * income * Affordability / 100)]
  ...
  let well-off-mortgage input-owners with [
    ...
    and ( ((income + (sum(income-rent) * TicksPerYear) * Affordability / 100) - (sum repayment) * TicksPerYear) > (median(repayment) * TicksPerYear) )]
  ...
  let well-off-social input-owners with [
  ...
  let right-to-buy-social input-owners with [
    on-market? = false
    and is-house? my-house
    and myType = "social"
    and time-in-social-house >= (right-to-buy-threshold * ticksPerYear)
  ...
  if right-to-buy? = true and any? right-to-buy-social [
  ...
  if any? not-well-off-evict-to-social [
    let sample one-of not-well-off-evict-to-social
  ]
  if any? well-off-social [
    let sample one-of well-off-social
  ]
  if any? right-to-buy-social [
    let sample one-of right-to-buy-social
  ]
end
...
to enter-market [candidates market-type]
  ask candidates [
    ...
    ;if market-type = "right-to-buy" [ ask one-of public-sectors [set waiting-list lput myself waiting-list] ]
  ]
end

to new-houses
   ;; some new houses are built, and put up for sale ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  repeat (count houses * HouseConstructionRate / 100) * (new-social-houses / 100) [
  ...
  repeat count houses * HouseConstructionRate / 100 * (1 - (new-social-houses / 100)) [
...
to trade-houses
  ...
  let houses-for-social houses with [ for-social? = true]
  let houses-for-rightToBuy houses with [for-rightToBuy? = true]
  ...
  make-offers buyers houses-for-sale houses-for-rent houses-for-social
  ...
  ask buyers with [ is-house? made-offer-on and on-market? = true and on-market-type != "social"] [           ;; ask buyers who have no houses and made offer on a house
...
to assign-social-housing
  ...
  ask vacant-houses-temp [
    ...
    if any? homeless-waiting [
      let eligible-homeless homeless-waiting with [ income * Affordability / (ticksPerYear * 100 ) >= [rent-price] of myself ]
    ...
    let eligible-occupiers occupiers-waiting with [ income * Affordability / (ticksPerYear * 100 ) >= [rent-price] of myself ]
  ...
  ifelse calculate-wealth? = true [
    ...
    if (ptype = "rent") or (ptype = "social" and [for-social?] of property = true) [
      ...
      [
        ...
        if ptype = "social" [set new-rent new-rent * (social-to-private-rent / 100)]
      ] ;; assign the median price of all record houses to new-price
...
to make-offers [buyers houses-for-sale houses-for-rent houses-for-social]
  ...
  ask buyers with [ on-market? = true and on-market-type = "social" ] [
    make-offer-social
  ]
    ...
    ask houses-to-demolish [
      ...
      if myType = "social" [
        ...
        if is-owner? my-occupier [
          ...
          evict my-occupier-temp
          ;; enter the rent market
          enter-market my-occupier-temp "social"
        ]
...
to update-owners
  ...
  ;; update the surplus income of all owners in the city (we exclude external houses)
  ask owners [
...
to update-globals
  ...
  if calculate-wealth? = True [
    ...
    set ageOwnershipWealth map [hh -> [(list (age / ticksPerYear) (length my-ownership) (wealth))] of hh] (sort owners with [my-house != "external"])
  ]
end
...
to trial
  ...
  set x medianRentPriceRentHouses
  set x medianRentPriceSocialHouses
  ...
  set x nWealth10k
  set x nWealth10k-50k
  set x nWealth50k-500k
  set x nWealth500k-1m
  set x nWealth1m-2m
  set x nWealth2m-5m
  set x nWealth5m
  set x gini-wealth
...
"External landlords" 1.0 0 -4699768 true "" "plot count owners with [my-house = \"external\"]"
...
"Right to buy" 1.0 0 -13345367 true "" "plot medianPriceRightToBuy"
...
"" ""
PENS
"houses for rent" 1.0 0 -11221820 true "" "plot medianPriceOfHousesForRent"
"private rent houses" 1.0 0 -13345367 true "" "plot medianRentPriceRentHouses"
"XY Locality" 1.0 0 -6459832 true "" "plot medianRentPriceXYLocality"
"XY ModifyRadius" 1.0 0 -955883 true "" "plot medianRentPriceXYModifyRadius"
"social houses" 1.0 0 -14439633 true "" "plot medianRentPriceSocialHouses"
"houses for-social" 1.0 0 -1184463 true "" "plot medianPriceOfHousesForSocial"
...
The version submitted to JASSS is 18.4
...
if (ticks / TicksPerYear) = pYear [set MaxLoanToValue pLTV]</go>
  ...
  <experiment name="W0_Baseline" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
  ...
  <experiment name="W0_InterestAt100_3.7to8" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [set InterestRate mInterest]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="W0_InterestAt100_8to3.7" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [set InterestRate mInterest]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="W0_LTVat100_60to90" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = pYear [set MaxLoanToValue pLTV]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="W0_LTVat100_90to60" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = pYear [set MaxLoanToValue pLTV]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="PatternOriented_interest" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [set InterestRate mInterest]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="PatternOriented_LTV" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = pYear [set MaxLoanToValue pLTV]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="UKPolicies_Baseline" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
    ...
    <enumeratedValueSet variable="pLTV-FirstTime">
      <value value="90"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="pLTV-BTL">
      <value value="90"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="jYear">
      <value value="100"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="jSD-A">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="jSD-B">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="jSD-C">
      <value value="false"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="kYear">
      <value value="100"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="kRTR">
      <value value="140"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="UKPolicies_LTVFT_90to99" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = pYear [
set MaxLoanToValue pLTV
set MaxLoanToValueFirstTime pLTV-FirstTime
set MaxLoanToValueBTL pLTV-BTL
]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
    <metric>count houses with [myType = "rent"]</metric>
  ...
  <experiment name="UKPolicies_LTVBTL_90to80" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = pYear [
set MaxLoanToValue pLTV
...
set MaxLoanToValueBTL pLTV-BTL
  ...
  <experiment name="UKPolicies_RTR_120to140" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = kYear [
set RentToRepayment kRTR
]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
    <metric>count houses with [myType = "rent"]</metric>
  ...
  <experiment name="UKPolicies_RTR_140to120" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = kYear [
set RentToRepayment kRTR
  ...
  <experiment name="UKPolicies_SDc_OnToOff" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = jYear [
set StampDuty-A? jSD-A
set StampDuty-B? jSD-B
set StampDuty-C? jSD-C
]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
    <metric>count houses with [myType = "rent"]</metric>
  ...
  <experiment name="UKPolicies_SDb_OnToOff" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = jYear [
set StampDuty-A? jSD-A
...
set StampDuty-C? jSD-C
  ...
  <experiment name="UKPolicies_SDa_OnToOff" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = jYear [
set StampDuty-A? jSD-A
...
set StampDuty-C? jSD-C
  ...
  <experiment name="UKPolicies_DurationFT_25to40" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = iYear [
set MortgageDurationFirstTime iFT
]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
    <metric>count houses with [myType = "rent"]</metric>
    ...
    <enumeratedValueSet variable="iYear">
      <value value="100"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="iFT">
      <value value="40"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="240210_baseline" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
    ...
    <metric>count owners with [on-market-type = "mortgage" and first-time? = true]</metric>
    <metric>count owners with [first-time? = true]</metric>
    <metric>median transactionsFirstTime</metric>
    <enumeratedValueSet variable="RentDropRate">
      <value value="3"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="jSD-B">
    ...
    <enumeratedValueSet variable="iDurationFT">
      <value value="40"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="FirstTimeBuyersStep">
      <value value="50"/>
    ...
    <enumeratedValueSet variable="IndependentAge">
      <value value="18"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="iDuration">
      <value value="25"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="iDurationBTL">
      <value value="25"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="SavingsRent">
      <value value="5"/>
    ...
    <enumeratedValueSet variable="pLTV-FT">
      <value value="90"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="WageRise">
      <value value="0"/>
  ...
  <experiment name="240210_LTV_FT90to99_20_50_80" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = pYear [
set MaxLoanToValue pLTV
set MaxLoanToValueFirstTime pLTV-FT
set MaxLoanToValueBTL pLTV-BTL
]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
  ...
  <experiment name="240210_Duration25to40_FT_20_50_80" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = iYear [
set MortgageDuration iDuration
set MortgageDurationFirstTime iDurationFT
set MortgageDurationBTL iDurationBTL
]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
    <metric>count houses with [myType = "rent"]</metric>
  ...
  <experiment name="240210_baseline_80density" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
    ...
    <enumeratedValueSet variable="cYear">
      <value value="100"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="cMaxDensity">
      <value value="100"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="240210_Density_80to100" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = cYear [
set MaxDensity cMaxDensity
]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
    <metric>count houses with [myType = "rent"]</metric>
  ...
  <experiment name="240210_Density_80to100_LTVFT_90to99" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = cYear [
set MaxDensity cMaxDensity
...
set Inheritance-tax? mInheritance
  ...
  <experiment name="240410 Baseline" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
  ...
  <experiment name="240410 Wealth_20k_30k_40k" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
  ...
  <experiment name="240410 changePrice_rich_300k_1m" repetitions="100" runMetricsEveryStep="true">
    <setup>setup
modify-prices</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [
modify-prices
set rich-immigrants 10
set rich-reference "XY modify radius houses"
]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
  ...
  <experiment name="240410 changePrice_NOrich_300k_1m" repetitions="100" runMetricsEveryStep="true">
    <setup>setup
modify-prices</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [
modify-prices
  ...
  <experiment name="240422 Baseline" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
    ...
    <enumeratedValueSet variable="rich-reference">
      <value value="&quot;XY modify radius houses&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="Savings">
      <value value="20"/>
    </enumeratedValueSet>
  ...
  <experiment name="240422 force_target" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
  ...
  <experiment name="240422 wealth_20k_40k" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
  ...
  <experiment name="240422 Baseline_investors" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
  ...
  <experiment name="240503 interestrise_wealth" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [
set InterestRate mInterest
...
set InterestRateBTL mInterestBTL
  ...
  <experiment name="240503 baseline" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
  ...
  <experiment name="240510 interestrise_wealth_100" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [
set InterestRate mInterest
...
set InterestRateBTL mInterestBTL
  ...
  <experiment name="240815_baseline" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
  ...
  <experiment name="240815_RTB_offToOn" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [set Right-to-buy? mRTB]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
    <metric>count houses with [myType = "rent"]</metric>
    <metric>count owners with [mytype = "mortgage"]</metric>
  ...
  <experiment name="240815_interest_3to8" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [
set InterestRate mInterest
...
set InterestRateRTB mInterestRTB
  ...
  <experiment name="240815_interest_8to3" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [
set InterestRate mInterest
...
set InterestRateRTB mInterestRTB
  ...
  <experiment name="240815_LTV_90to60" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [
set MaxLoanToValue mLTV
...
set MaxLoanToValueRTB mLTV-RTB
  ...
  <experiment name="240815_LTV_60to90" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [
set MaxLoanToValue mLTV

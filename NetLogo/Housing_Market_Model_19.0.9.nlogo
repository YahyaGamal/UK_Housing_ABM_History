...
globals[
  ...
  medianSalePriceHouses             ; median sale-price of all the houses for sale
  medianRentPriceHouses             ; median rent-price of all the houses for rent
...
;        ]
      ...
      or force-external-landlord = true [
        ...
        [
          ...
          ;; Enter the market on the basis of myType (i.e., either "mortgage" or "rent")
          enter-market self "buy-to-let"
      ...
      ;; if the new owner should not be an external landlord
      [
        set color gray  ;; gray
...
;          if interestPerTick-temp = 0 [type "interestPerTick-temp = " type interestPerTick-temp type "\n"]
;          if item i mortgage-duration = 0 [type self type " | mortgage-duration = " type mortgage-duration type "\n"]
;          if (1 - ( 1 + interestPerTick-temp ) ^ ( - (item i mortgage-duration) * ticksPerYear )) = 0 [type self type " | mortgage-duration = " type item i mortgage-duration type ", minterestPerTick-temp = " type interestPerTick-temp type ", ticksPerYear = " type ticksPerYear type ", total-mortgage = " type total-mortgage type "\n"]
          let new-repayment 0
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot (count houses with [myType = \"mortgage\"] / count houses) * 100"
...
608
debug
if ticks = 0 [set InterestRate 3.7\nset InterestRateFirstTime 3.7\nset InterestRateBTL 3.7\nsetup\n]\ngo\nif (ticks / TicksPerYear) = mYear [\nset InterestRate mInterest\nset InterestRateFirstTime mInterestFT\nset InterestRateBTL mInterestBTL\n]\nif (ticks / TicksPerYear) >= nYears [\nset InterestRate 3.7\nset InterestRateFirstTime 3.7\nset InterestRateBTL 3.7\nsetup\n]
T
1
T
OBSERVER

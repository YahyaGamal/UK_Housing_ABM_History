...
;; parameters taken from http://www2.physics.umd.edu/~yakovenk/papers/PhysicaA-370-54-2006.pdf
  ...
  if (MeanIncome-step = true and setup? = false) or (MeanIncome-setup = true and setup? = true) [
    set MeanIncome-temp max list (mean [sale-price] of houses with [myType = "mortgage"]) (medianPriceOfHousesForSale)
  ]
  ...
  if myType = "mortgage" [
    ...
    set capital income * CapitalMortgage / 100  ;; save up money or captial for buying houses every year
  ]
...
to update-visualisation
  ...
  ;; this mode has to be called every step (computationally demanding)
...
VisualiseMode
VisualiseMode
"Types" "Prices" "Diversity by prices"
0
...
Version 18.3 (YG)
1. Added a mode where the capital and income of agents is set based on the house prices and rents

      ...
      ask turtle-set sales-to-remove [
        ...
        ask turtle-set filed-at-houses [
          ...
          foreach local-sales [
            ...
            records-list ->
            ;type self type "\n"
            ;type "sale pre  = " type length records-list type "\n"
            ...
            ;type "sale post = " type length item index local-sales type "\n"
            ;repeat 50 [type "#"] type "\n"
          ]
        ]
      ]
      ...
      ask turtle-set rents-to-remove [
        ask turtle-set filed-at-houses [
          foreach local-rents [
            records-list ->
            ;type self type "\n"
            ;type "rent pre  = " type length records-list type "\n"
            ...
            ;type "rent post = " type length item index local-rents type "\n"
            ;repeat 50 [type "#"] type "\n"
          ]
        ]
      ]

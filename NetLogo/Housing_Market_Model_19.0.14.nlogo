...
to reset
  ...
  if baseline-type = "Weekly step" [
    ...
    set InterestRateBTL 3.71
    set InterestRateFirstTime 3.72
    ...
    set MortgageDurationBTL 24
    set MortgageDurationFirstTime 39
  ...
  if baseline-type = "1-month step" [
    set Affordability 33
    set Baseline-type "1-month step"
    set BuyerSearchLength 10
    set calculate-wealth? true
    set CapitalMortgage 100
    set CapitalRent 52
  ...
  if baseline-type = "3-month step" [
    set Affordability 33
    set Baseline-type "3-month step"
    set BuyerSearchLength 10
    set calculate-wealth? true
    set CapitalMortgage 100
    set CapitalRent 52
...
to step
  ...
  ;type "update-income | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type ", homeless regitered by a house = " type count houses with [is-owner? my-occupier and not is-house? [my-house] of my-occupier] type "\n"
  ...
  ;type "owners-leave | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type ", homeless regitered by a house = " type count houses with [is-owner? my-occupier and not is-house? [my-house] of my-occupier] type "\n"
  set n-owners count owners  ;; take a count of total owners at the moment
  set owner-occupiers owners with [ is-house? my-house ] ; all owners who are living

  ; owners entering naturally
  new-owners n-owners
  ;type "new-owners | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type ", homeless regitered by a house = " type count houses with [is-owner? my-occupier and not is-house? [my-house] of my-occupier] type "\n"
  ...
  manage-discouraged
  ;type "manage-discouraged | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type ", homeless regitered by a house = " type count houses with [is-owner? my-occupier and not is-house? [my-house] of my-occupier] type "\n"
  set n-owners count owners  ;; take a count of total owners at the moment
  set owner-occupiers owners with [ is-house? my-house ] ; all owners who are living
  ...
  ;type "manage-market-participation | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type ", homeless regitered by a house = " type count houses with [is-owner? my-occupier and not is-house? [my-house] of my-occupier] type "\n"


  ; introduce new houses
  new-houses
  ;type "new-houses | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type ", homeless regitered by a house = " type count houses with [is-owner? my-occupier and not is-house? [my-house] of my-occupier] type "\n"

  ; trading and moving into houses
  trade-houses
  ;type "trade-houses | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type ", homeless regitered by a house = " type count houses with [is-owner? my-occupier and not is-house? [my-house] of my-occupier] type "\n"

  ;remove extras (this removes all the offers, but still keeps the houses on the market)
  remove-outdates
  ;type "remove-outdates | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type ", homeless regitered by a house = " type count houses with [is-owner? my-occupier and not is-house? [my-house] of my-occupier] type "\n"

  ; demolish old houses
  demolish-houses
  ;type "demolish-houses | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type ", homeless regitered by a house = " type count houses with [is-owner? my-occupier and not is-house? [my-house] of my-occupier] type "\n"
  ; decay the prices of houses
  update-prices
  ;type "update-prices | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type ", homeless regitered by a house = " type count houses with [is-owner? my-occupier and not is-house? [my-house] of my-occupier] type "\n"
  ; update the homeless owners, discourage those who exceed the maxhomelesslimit and manage income/capital
  update-owners
  ;type "update-owners | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type ", homeless regitered by a house = " type count houses with [is-owner? my-occupier and not is-house? [my-house] of my-occupier] type "\n"
  ; clear the administrators that no longer own any houses
  update-administrators
  ;type "update-administrators | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type ", homeless regitered by a house = " type count houses with [is-owner? my-occupier and not is-house? [my-house] of my-occupier] type "\n"
  ; manage the aging process (age 1 tick, breed, and die)
  if simulate-aging? = true [manage-age]
  ;type "manage-age | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type ", homeless regitered by a house = " type count houses with [is-owner? my-occupier and not is-house? [my-house] of my-occupier] type "\n"
  ; calculate globals (if needed)
  update-globals
  ;type "update-globals | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type ", homeless regitered by a house = " type count houses with [is-owner? my-occupier and not is-house? [my-house] of my-occupier] type "\n"
  if force-target = true [manage-targets]
  ;type "manage-targets | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type ", homeless regitered by a house = " type count houses with [is-owner? my-occupier and not is-house? [my-house] of my-occupier] type "\n"
...
to owners-die [owners-to-die]
  ask owners-to-die [
    if myType = "rent" or myType = "social" [
      ...
      ;type "manage-age, owners-die " type self type " | myType = " type myType type ", my-house = " type my-house type " | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type ", homeless regitered by a house = " type count houses with [is-owner? my-occupier and not is-house? [my-house] of my-occupier] type "\n"
      die
    ]
...
;  set entryLag entryLag + totalEntry - floor nEntry
;  if entryLag >= 1 [
;    set entryLag entryLag - 1
;    set totalEntry totalEntry + 1
;  ]
...
to manage-discouraged
  ...
  if onMarketPeriodBTL > 0 [
    ask owners with [member? "buy-to-let" on-market-type] [
  ...
  if onMarketPeriodMortgage > 0 [
    ask owners with [member? "mortgage" on-market-type] [
...
to manage-market-participation [input-owners]
  ...
  ;type "manage-market-participation, not-well-off-evict-to-rent | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type "\n"
  ...
  ;type "manage-market-participation, not-well-off-evict-to-social | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type "\n"
...
to trade-houses
  ...
  ;type "trade-houses, make-offers | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type "\n"
  ...
  ;type "trade-houses, assign-social-housing | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type "\n"
  ...
  ;type "trade-houses, move-house | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type "\n"
...
to move-house [buyer-tenant]
  ...
  ;type "Pre move-house " type buyer-tenant type ", old-house = " type my-house type ", new-house = " type new-house type ", on-market-type " type on-market-type type  " | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type ", homeless regitered by a house = " type count houses with [is-owner? my-occupier and not is-house? [my-house] of my-occupier] type "\n"
  ...
  ;type "Post move-house " type buyer-tenant type ", old-house = " type my-house type ", new-house = " type new-house type ", on-market-type " type on-market-type type  " | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type ", homeless regitered by a house = " type count houses with [is-owner? my-occupier and not is-house? [my-house] of my-occupier] type "\n"
...
;      type "manage-age, give-inheritance " type self type " | myType = " type myType type ", my-house = " type my-house type " | vacant social outside of vacant-houses list = " type count houses with [myType = "social" and not is-owner? my-occupier and not member? self [vacant-houses] of public-sector 0] type ", homeless regitered by a house = " type count houses with [is-owner? my-occupier and not is-house? [my-house] of my-occupier] type "\n"
      owners-die self
      stop
    ]
...
"houses for-social" 1.0 0 -1184463 true "" "plot medianPriceOfHousesForSocial * ticksPerYear"
"All social houses" 1.0 0 -14439633 true "" "plot medianRentPriceSocialHouses * ticksPerYear"
"Houses for-rent" 1.0 0 -11221820 true "" "plot medianPriceOfHousesForRent * ticksPerYear"
...
The versions submitted to JASSS is 18.4 and 18.4.2
...
@#$#@#$#@
<experiments>
  <experiment name="240830 Baseline_ticksPerYear_4_12_52" repetitions="20" runMetricsEveryStep="true">
    <setup>reset
setup</setup>
    <go>go</go>
    ...
    <enumeratedValueSet variable="Baseline-type">
      <value value="&quot;Weekly step&quot;"/>
      <value value="&quot;1-month step&quot;"/>
      <value value="&quot;4-month step&quot;"/>
    </enumeratedValueSet>
  ...
  <experiment name="240830 Baseline_socialHouses_10to25" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="240830 Interest_3to8_varyTicksPerYear" repetitions="10" runMetricsEveryStep="true">
    <setup>reset
setup</setup>
    <go>go
if ticks = 1200 [

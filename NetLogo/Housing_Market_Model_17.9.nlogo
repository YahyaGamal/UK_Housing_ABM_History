...
7. When making trade offers, owners only consider houses that they can afford to in terms of mortgage repayments
...
@#$#@#$#@
<experiments>
  <experiment name="Base" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="Interest rate" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
  ...
  <experiment name="Investors" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
  ...
  <experiment name="Upgrade-tenancy" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
  ...
  <experiment name="InterestAt50" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go

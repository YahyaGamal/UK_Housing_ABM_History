...
"" ""
PENS
"Wealth" 1.0 0 -16777216 true "" "plot median [wealth] of owners with [is-house? my-house]"
...
if (ticks / TicksPerYear) = pYear [set MaxLoanToValue pLTV]</go>
  ...
  <experiment name="W0a_Baseline" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
    <metric>count houses with [myType = "mortgage"]</metric>
  ...
  <experiment name="W0a_InterestAt300_3.7to8" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [set InterestRate mInterest]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="W0a_InterestAt300_8to3.7" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [set InterestRate mInterest]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="W0a_LTVat300_60to90" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = pYear [set MaxLoanToValue pLTV]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="W0a_LTVat100_90to60" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = pYear [set MaxLoanToValue pLTV]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="W0b_InterestAt300_3.7to8_varyInitial" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [set InterestRate mInterest]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="W0b_InterestAt300_8to3.7_varyInitial" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = mYear [set InterestRate mInterest]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="W0b_LTVat300_60to90_varyInitial" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = pYear [set MaxLoanToValue pLTV]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
  ...
  <experiment name="W0b_LTVat100_90to60_varyInitial" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go
if (ticks / TicksPerYear) = pYear [set MaxLoanToValue pLTV]</go>
    <exitCondition>(ticks / TicksPerYear) &gt;= nYears</exitCondition>
